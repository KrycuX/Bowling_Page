          ...
          <Card className="animate-fade-in">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">Telefonicznie</h3>
                  <a href="tel:+48123456789" className="text-purple-300 hover:text-purple-200 transition-colors">
                    +48 123 456 789
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:rezerwacje@thealley2b.pl" className="text-[#A78BFA] hover:text-[#8B5CF6] transition-colors">
            ...
            <div className="bg-purple-800/30 rounded-lg p-6 md:p-8 text-center mt-6">
