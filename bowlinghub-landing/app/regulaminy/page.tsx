      ...
      <main className="flex-1 container mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-slate-900/60 backdrop-blur-sm rounded-lg p-8 border border-sky-800/40">
              <h2 className="text-2xl font-bold text-white mb-4">Regulamin korzystania z obiektu</h2>
              <div className="space-y-4 text-white/90">
                <p>
                  Regulamin określa przykładowe zasady korzystania z obiektu demonstracyjnego
                  &nbsp;„Demo Bowling Center”. Tekst ma charakter poglądowy.
                </p>
