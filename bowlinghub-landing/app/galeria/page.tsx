...
const BOOKING_API_URL = process.env.NEXT_PUBLIC_BOOKING_API_URL || 'https://api.bowlinghub.pl';
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold transition-colors ${
                selectedSection === null
                  ...
                  : 'bg-slate-900/60 text-white/80 hover:bg-slate-800/80'
              }`}
            >
              Wszystkie
            </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {images.map((img) => {
              ...
              return (
                <div
                  key={img.id}
                  className="aspect-square rounded-lg border border-sky-800/40 overflow-hidden hover:border-sky-500 transition-all cursor-pointer group relative"
                >
                  <Image
                    src={imageUrl}
